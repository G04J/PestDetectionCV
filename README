...
Manual inspection of pest damage on crops is slow and resource intensive. Automated pest detection using computer vision can significantly accelerate monitoring by identifying and localizing pests in images. PestDetectionCV implements and evaluates two detection paradigms:
...
Extract data to Colab workspace

Upload and run train_dropout.py
...
Data preprocessing and annotation conventions

Implementation of deep learning object detection models

GPU-based training workflows in Google Colab

Model evaluation using robust metrics

Code organization for machine learning projects

Experiment tracking and comparison

Practical inference and visualization
...
Select model (Faster R-CNN or YOLOv8n)

For Colab training, upload necessary scripts

Run training and evaluation

Perform inference using saved weights

12. Future Work

Possible improvements include:

Integration with a live camera feed for real-time detection

Deployment on edge hardware (Jetson Nano, Raspberry Pi)

Semi-supervised learning to reduce annotation effort

Augmentation strategies for greater noise tolerance
